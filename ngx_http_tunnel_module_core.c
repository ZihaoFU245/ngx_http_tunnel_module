...
static ngx_int_t ngx_http_tunnel_set_proxy_authenticate(ngx_http_request_t *r);
static ngx_int_t ngx_http_tunnel_access_denied(ngx_http_request_t *r,
                                               ngx_http_tunnel_srv_conf_t *tscf);
static ngx_int_t ngx_http_tunnel_check_auth(ngx_http_request_t *r,
                                            ngx_http_tunnel_srv_conf_t *tscf);
                           ...
                           ngx_http_tunnel_srv_conf_t *tscf)
{
    ...
    if (colon == NULL || colon == decoded.data || colon == decoded.data + decoded.len)
    {
        return ngx_http_tunnel_access_denied(r, tscf);
    }
